...
<body onload="setYear()">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item">
			<a class="nav-link active" href="#">Binary to Decimal</a>
		</li>
		<li class="nav-item">
			<a class="nav-link inactive" href="dectobin.php">Decimal to Binary</a>
		</li>
	</ul>
	<!-- Conent -->
	<div class="container-fluid content">
		...
		<div class="row-fluid text-center">
			<div class="col-10 offset-1 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-4 input-group">
				<div class="input-group-addon" id="addon">2</div>
				<textarea class="form-control text-left autoexpand" name="inputval" id="inputval" type="text" placeholder="1000010111110000111110110001001" onkeyup="bazinga();" rows=1; data-min-rows='1' input></textarea>
			</div>
		</div>
		<br/>
		<!-- Radio Buttons -->
